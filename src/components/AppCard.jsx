...
export default function AppCard({ name, description, icon: Icon, color, link }) {
  return (
    ...
    >
      <Link to={link}>
        <div className="h-full bg-gradient-to-br from-gray-900 to-black border-2 border-gray-800 hover:border-red-600 rounded-2xl p-7 cursor-pointer group overflow-hidden relative">
          ...
          <div className="relative">
            ...
            <h3 className="text-xl font-bold text-white mb-2 group-hover:text-red-500 transition-colors">{name}</h3>
            <p className="text-gray-400 text-sm mb-6 leading-relaxed">{description}</p>
            <div className="flex items-center text-red-500 group-hover:text-red-400 font-bold transition-colors">
