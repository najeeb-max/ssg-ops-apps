  ...
  return (
    <div className="bg-blue-50/40 border border-blue-100 rounded-xl p-4 mt-3 space-y-3">
      <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
        <TypewriterInput label="Company Name *" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} placeholder="Supplier Co." className="text-sm h-9" />
        <TypewriterInput label="Contact Person" value={form.contact_person} onChange={(e) => setForm({ ...form, contact_person: e.target.value })} placeholder="John Doe" className="text-sm h-9" />
        <TypewriterInput label="Delivery Period" value={form.delivery_period} onChange={(e) => setForm({ ...form, delivery_period: e.target.value })} placeholder="4-6 weeks" className="text-sm h-9" />
        <TypewriterInput label="Payment Terms" value={form.payment_terms} onChange={(e) => setForm({ ...form, payment_terms: e.target.value })} placeholder="30 days" className="text-sm h-9" />
        <TypewriterInput label="Delivery Terms" value={form.delivery_terms} onChange={(e) => setForm({ ...form, delivery_terms: e.target.value })} placeholder="FOB, CIF..." className="text-sm h-9" />
        <div>
